...
export default function AchievementsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#020204] p-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center text-white">
            ...
            <button
              ...
              className="border border-[#00d4ff] bg-transparent text-[#00d4ff] hover:bg-[#00d4ff] hover:text-black font-bold py-3 px-6 rounded-none transition-all duration-200"
            >
              Try Again
            </button>
          </div>
